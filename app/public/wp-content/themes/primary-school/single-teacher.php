...
?>
  ...
  <div class="container container--narrow page-section">
    <div class="metabox metabox--position-up metabox--with-home-link">
      <p><a class="metabox__blog-home-link" href="<?php echo get_post_type_archive_link('teacher'); ?>"><i class="fa fa-home" aria-hidden="true"></i> Teacher(s) Profile Home</a> <span class="metabox__main"><?php the_title(); ?></span></p>
    </div>
